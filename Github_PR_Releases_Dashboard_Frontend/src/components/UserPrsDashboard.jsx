...
//       {loading ? (
//         <div className="text-center py-4" style={{ color: darkMode ? "#ffffff" : "#000000" }}><Spinner animation="border" style={{ color: darkMode ? "#61dafb" : "#007bff" }} /></div>
//       ) : displayedPrs.length ? (
//         <>
//           <Table 
//             striped 
...
//         <a href={p.html_url} target="_blank" rel="noreferrer" style={{ color: darkMode ? "#61dafb" : "#007bff", textDecoration: "none" }}>
//           {p.title}
//         </a>
//       </td>
...
//         {p.requested_reviewers?.length ? (
//           p.requested_reviewers.map((r, i) => (
//             <Badge key={i} bg="info" text={darkMode ? "light" : "dark"} className="me-1">
//               {r}
//             </Badge>
//           ))
//         ) : (
...
//       <td style={{ color: darkMode ? "#ffffff" : "#000000" }}>{new Date(p.created_at).toLocaleString()}</td>
...
//           <Pagination className="justify-content-center" style={{ backgroundColor: darkMode ? "transparent" : "transparent" }}>
//             <Pagination.First onClick={() => handlePageChange(1)} disabled={page === 1} />
//             <Pagination.Prev onClick={() => handlePageChange(Math.max(1, page - 1))} disabled={page === 1} />
//             {getPageNumbers().map((p) => (
//               <Pagination.Item key={p} active={p === page} onClick={() => handlePageChange(p)} style={{ backgroundColor: p === page ? (darkMode ? "#61dafb" : "#007bff") : "transparent", color: darkMode ? "#ffffff" : "#000000" }}>{p}</Pagination.Item>
//             ))}
//             <Pagination.Next onClick={() => handlePageChange(Math.min(totalPages, page + 1))} disabled={page === totalPages} />
//             <Pagination.Last onClick={() => handlePageChange(totalPages)} disabled={page === totalPages} />
//           </Pagination>
//         </>
//       ) : (
//         <div className="text-center py-4" style={{ color: darkMode ? "#ffffff" : "#000000" }}>No pull requests found</div>
//       )}
//     </div>
//   );
// };
